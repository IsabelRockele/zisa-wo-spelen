...
['de legende','assets/woordenschat-l1/legende-duidelijk-l1-v3.svg','De uitleg van kleuren en tekens op een kaart.','what'],
...
['de omgeving',local+'omgeving-echte-foto.png?v=20260825b','Alles wat rond een plek of persoon is.','place'],
...
document.querySelectorAll('[data-view]').forEach(b=>b.onclick=()=>show(b.dataset.view));document.querySelector('#printButton').onclick=()=>{if(document.body.dataset.view==='homework'){document.querySelector('#hwPrint')?.click();return}document.body.dataset.view==='cards'&&document.querySelector('#cards .card.chosen')?printCardSelection():print()};show('cards');
