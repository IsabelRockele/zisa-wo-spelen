...
['het adres',local+'adres-zelfde-als-l2.webp','De plaats waar iemand woont: straatnaam, huisnummer, postcode en gemeente.','what'],
...
['het dorp',local+'dorp-echte-foto.png','Een kleine plaats met weinig huizen en veel groen.','place'],
...
['de maquette',local+'maquette-echte-foto.png','Een gebouw of omgeving die in het klein is nagemaakt.','what'],
['de natuur',l2+'gebied-natuurgebied-foto-v2.webp','Alles wat niet door mensen is gemaakt, zoals planten en dieren.','what'],
['de omgeving',local+'omgeving-echte-foto.png','Alles wat rond een plek of persoon is.','place'],
...
['de postcode',local+'postcode-op-adres.svg','Een nummer bij een gemeente dat helpt om post juist te bezorgen.','what'],
