(()=>{
  const tasks=[
    ...
    {text:'Klik op het secretariaat van juf Ilse.',emoji:'🗂️',polygons:[[[53,64.2],[57.1,64.2],[57.1,70.3],[53,70.3]]]},
    {text:'Klik op het bureau van directeur juf Elien.',emoji:'🧑‍💼',polygons:[[[54.5,70.3],[57.2,70.3],[57.2,74],[54.5,74]]]},
