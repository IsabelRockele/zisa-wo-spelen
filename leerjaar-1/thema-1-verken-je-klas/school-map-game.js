(()=>{
  const tasks=[
    ...
    {text:'Klik op het secretariaat van juf Ilse.',emoji:'🗂️',polygons:[[[54.7,62.5],[56.4,62.5],[56.5,64.7],[54.7,64.8]]]},
    {text:'Klik op het bureau van directeur juf Elien.',emoji:'🧑‍💼',polygons:[[[54.8,65],[56.6,65],[56.6,68],[54.8,68]]]},
