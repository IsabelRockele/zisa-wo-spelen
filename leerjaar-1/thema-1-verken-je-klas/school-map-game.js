(()=>{
  const tasks=[
    ...
    {text:'Klik op het secretariaat van juf Ilse.',emoji:'🗂️',zones:[{x:46,y:73,rx:7,ry:8}]},
    {text:'Klik op het bureau van directeur juf Elien.',emoji:'🧑‍💼',zones:[{x:48,y:75,rx:6,ry:7}]},
    {text:'Klik op de klas van juf Anuschka, het vierde leerjaar.',emoji:'4️⃣',zones:[{x:49,y:62,rx:6,ry:6}]},
