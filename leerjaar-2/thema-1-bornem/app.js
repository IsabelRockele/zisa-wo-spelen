...
const areaQuestions=[
 {q:'Welk gebied zie je op deze afbeelding?',img:'woningen-samen-eigen.webp',right:'woongebied'},
 {q:'Welk gebied zie je op deze afbeelding?',img:'natuurgebied-illustratie.jpg',right:'natuurgebied'},
 {q:'Welk gebied zie je op deze afbeelding?',img:'landbouwgebied-illustratie.jpg',right:'landbouwgebied'},
 {q:'Welk gebied zie je op deze afbeelding?',img:'industriegebied-illustratie.jpg',right:'industriegebied'},
...
function render(){if(state.index>=state.items.length)return result();({beeldwoord:pictureMatch,betekenis:meaning,bornem:bornem,sorteren:sort,toets:test,bord:board,kaartvak:mapGridExercise,afvalladder:wasteLadderGame,gebieden:areaGame}[state.game])();addPromptAudio();addAnswerAudio()}
