...
function render(){if(state.index>=state.items.length)return result();({beeldwoord:pictureMatch,betekenis:meaning,bornem:bornem,sorteren:sort,toets:test,bord:board,wonen:housing,afval:waste}[state.game])();addPromptAudio();addAnswerAudio()}
