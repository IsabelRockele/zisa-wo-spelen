...
const games=[
 ...
 ,{id:'vindplek',icon:'👆',title:'Zoek en klik op de kaart',text:'Vind Bornem, onze school, de deelgemeenten en de buurgemeenten.',img:'provincie-antwerpen-gemeenten.gif'}
];
